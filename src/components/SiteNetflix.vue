<template>
    ...
    <section class="init_content">
        
        <div class="content">
            <div>
                <img src="../assets/esqaudrao6.webp" alt="Esquadrão 6">
    ...
    <div class="feed">
        <div class="colections">
            ...
            <div class="colection">
                ...
                <NetCards :filmes="filmesSugeridos"></NetCards>
            </div>

             <div class="colection">
                <h3>Em alta</h3>

                <NetCards :filmes="recomendados"></NetCards>
            </div>
...
<script>
    import NetCards from "./NetCards.vue";
    import HeaderNet from './HeaderNet.vue';
    ...
    name:'homePage',
        ...
        mounted () {
            axios
            .get('http://127.0.0.1:8000/api/filmes')
                .then((resposta)=>{
        ...
        computed:{
               filmesSugeridos(){
                ...
                return this.filmes.filter((filme,index) => index < 5)
            },
            ...
            recomendados(){
                ...
                return this.filmes.filter((filme, index) =>  filme.avaliacao < 10 && index != null)
            }
        },methods:{
...
:root{
    ...
    --NRed: #e50914;
    --darkGray:#141414;
    --buttonGray: rgba(109,109,110,0.7);
}
...
.colored-menu {
    ...
    background: linear-gradient(to bottom, #141414 10%, #1d1d1d 100%);
...
/*   seçao inicial que mostra o primeiro filme    */
...
.init_content {
    ...
    width: 100% ;
    height: 100vh;
    background: linear-gradient(to bottom, transparent 90%, #141414 100%), url('https://occ-0-2095-1740.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABQnsjlUbQsJyMY6BgNHVZXaeDx8V1DZ95dZN9cr-hjpyKwcRb-Sl9O_QK7RGFAMxmNItqUDXbhoPUhPnxu9d2Sdhv-1w.webp?r=a60' ) no-repeat;
...
.init_content .content > div  img{
    width: 100%;

}

.init_content .content > div p {
...
.init_content .content > div button {
...
.init_content .content > div button svg {
...
.init_content .content > div .buttons {
...
.init_content .content > div .bt_dois{
...
.init_content .content > div .bt_dois svg {
...
.init_content .indicators .bt-restart button svg{
    color: #fff;
}

.init_content .indicators .maturity-warning  {
...
.init_content .indicators .maturity-warning .maturity {
    width: 40px;
    height: 40px;
...
.init_content .indicators .maturity p {
...
.footer .footer_content .menu_img{

    margin-left: 20px

}

.footer .footer_content .menu_img a{
    margin-left: 10px;
}


.footer .footer_content .menu_img svg{
...
.footer .footer_content .menu_list{
    display: flex;

}


.footer .footer_content .menu_list ul{
...
.footer .footer_content .menu_list ul li{
...
.footer .footer_content .menu_list ul li a{
    color:rgba(109,109,110,0.7);
}

.footer .footer_content .menu_list ul li a:hover{
